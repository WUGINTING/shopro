...
export interface User {
  ...
  /** Email æ˜¯å¦å·²é©—è­‰ï¼ˆæœƒå“¡éœ€é©—è­‰å¾Œæ‰èƒ½æŸ¥çœ‹ä»¥è©² Email ä¸‹çš„è¨‚å–®ï¼‰ */
  emailVerified?: boolean
  /** è®Šæ›´å¸³è™Ÿå¾Œå›å‚³çš„æ–°ç™»å…¥ token */
  token?: string
  /** ?¯å¦?Ÿç”¨ */
  enabled?: boolean
  /** ?µå»º?‚é? */

<template>
  <q-page>
      ...
      <div class="container q-mx-auto">
        ...
        <div class="menu-content">
          ...
          >
            ...
            <div class="row q-gutter-lg">
              ...
              >
                <menu-card :dish="service" @click="openServiceDialog(service)" />
              </div>
            </div>
          </div>
        </div>
        ...
        <section class="section-padding">
          <div class="text-center q-mb-xl fade-in-up">
            ...
            <div class="story-divider q-mx-auto q-mb-lg"></div>
            <p class="text-body1 text-grey-4">專為企業設計的服務組合</p>
          </div>
                  ...
                  >
                    <div class="absolute-top-right q-pa-sm">
                      <q-chip
                        ...
                        text-color="white"
                        :label="package_.popular ? '熱門推薦' : '經典方案'"
                      />
                    </div>
                  </q-img>
                </div>
                ...
                <q-card-section class="q-pa-lg">
                  ...
                  <div class="package-details q-mb-md">
                    ...
                    <div class="detail-item">
                      <Icon icon="mdi:star" class="text-secondary q-mr-sm" />
    ...
    <!-- 服務詳情對話框 -->
    <q-dialog v-model="serviceDialog" class="dish-dialog">
      <q-card
      ...
      >
        ...
        <q-card-section v-if="selectedService" class="q-pa-lg">
          <div class="text-h5 text-weight-bold q-mb-sm">
          ...
          <div v-if="selectedService.ingredients" class="ingredients q-mb-md">
          ...
          <div v-if="selectedService.allergens" class="allergens q-mb-md">
            <div class="text-subtitle2 text-weight-bold q-mb-sm">
              注意事項：
            </div>
            <div class="text-body2 text-orange">
              {{ selectedService.allergens }}
            </div>
          </div>
